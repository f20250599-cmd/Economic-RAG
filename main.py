...
# Streamlit UI setup
st.title("EcoSphere Intelligence: RAG Driven Framework")
st.caption("Architecting precision retrieval to eliminate hallucinations across complex, fragmented data ecosystems")
...
st.sidebar.title("📄 Upload Economic News Files ")
uploaded_files = st.sidebar.file_uploader(
    "Upload Finantial News Articles , Reports, or Market Updates",
    type=["txt", "pdf"],
...
if uploaded_files:
    for uploaded_file in uploaded_files:
        ...
        if raw_text.strip():
            chunks = chunk_text(raw_text, max_tokens=150)
